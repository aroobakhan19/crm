...
const OfficeAvability = () => {
    ...
    return (
        ...
        <Header />
            ...
            <Typography sx={{ ml: { xs: 0, md: '40%' }, mt: { md: 12, xs: 10 }, color:'#1982C4',fontWeight:'bold' }} variant='h3'>Add office Avability</Typography>
            <Box sx={{ ml: "30%", mt: 5, width: '70%' }}>
        <Card sx={{ maxWidth: 800, boxShadow: 20, backgroundColor: 'beige', borderRadius: '8px' }}>
          <CardContent>
            <Typography
              sx={{ fontWeight: "bold", color: '#1982C4', fontFamily: 'Arial, sans-serif', fontSize: '20px' }}
              variant='h6'
            >
            ...
            >
              ...
              <Box sx={{ width: '48%' }}>
                <Typography sx={{ fontWeight: 'bold', color: '#011936' }} variant="body1">
                            ...
                            <Box sx={{ display: 'flex', justifyContent: 'space-between', mt: 4 }}>
              <Box sx={{ width: '48%' }}>
                <Typography sx={{ fontWeight: 'bold', color: '#011936' }} variant="body1">Requirement Type</Typography>
                                <Select
